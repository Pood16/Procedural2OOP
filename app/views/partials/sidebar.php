...
<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
            ...
            <nav class="mt-10">
                <a class="<?= htmlspecialchars($_SERVER['REQUEST_URI']) == '/admin' ? 'text-white bg-gray-700 ' : '' ?> flex items-center px-6 py-2 mt-4 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 " href="/admin">
                ...
                <a class="<?= htmlspecialchars($_SERVER['REQUEST_URI']) == '/admin/users' ? 'text-white bg-gray-700 ' : '' ?> flex items-center px-6 py-2 mt-4 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
                    href="/admin/users">
                ...
                <a class="<?= htmlspecialchars($_SERVER['REQUEST_URI']) == '/admin/categories' ? 'text-white bg-gray-700 ' : '' ?> flex items-center px-6 py-2 mt-4 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
                ...
                <a class="<?= htmlspecialchars($_SERVER['REQUEST_URI']) == '/admin/projects' ? 'text-white bg-gray-700 ' : '' ?> flex items-center px-6 py-2 mt-4 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
                    href="/admin/projects">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a class="<?= htmlspecialchars($_SERVER['REQUEST_URI']) == '/admin/testimonials' ? 'text-white bg-gray-700 ' : '' ?> flex items-center px-6 py-2 mt-4 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
